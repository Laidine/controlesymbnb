 ...
 */
final class Version20211020073429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD catego_id INT NOT NULL, DROP catego');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD catego VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP catego_id');
    }
}
